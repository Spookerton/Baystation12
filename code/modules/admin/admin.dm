...
/datum/admins/proc/show_player_panel(mob/M in SSmobs.mob_list)
	...
	if(isliving(M))
		...
		if(psyker.psi)
			body += "<a href='byond://?src=\ref[psyker.psi];remove_psionics=1'>Remove Psyker abilities.</a><br/><br/>"
	...
	if (M.client)
		if(!istype(M, /mob/new_player))
			...
			body += {"<br><br>
				...
				<A href='byond://?src=\ref[src];simplemake=human;species=Kroot;mob=\ref[M]'>Kroot</A>
